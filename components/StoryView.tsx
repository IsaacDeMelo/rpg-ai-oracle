  ...
  return (
    <div className="flex flex-col h-full relative" style={{ perspective: '2000px' }}>
      ...
      <div className={`flex-1 relative flex flex-col items-center justify-start transition-all duration-700 ${hasOpened ? 'book-enter-active' : 'book-enter'}`}>
        ...
        {/* The "Paper" */}
        <div className={`
            relative w-full max-w-4xl min-h-[85vh] bg-[#f5f5f4] shadow-[0_0_50px_rgba(0,0,0,0.8)] 
        ...
        `}>
            ...
            <div className="relative z-20 flex flex-col h-full p-8 md:p-12 pb-24">
                ...
                {/* Main Text Area */}
                <textarea 
                    className="flex-1 w-full bg-transparent resize-none focus:outline-none text-stone-900 font-serif text-base leading-relaxed custom-scrollbar placeholder-stone-400/50"
